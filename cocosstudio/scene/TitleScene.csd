<GameProjectFile>
  <PropertyGroup Type="Scene" Name="TitleScene" ID="f939d589-ba62-49df-bf2a-eb9e08c3156d" Version="2.3.0.1" />
  <Content ctype="GameProjectContent">
    <Content>
      <Animation Duration="30" Speed="1.0000">
        <Timeline ActionTag="1639431976" Property="Scale">
      ...
      <ObjectData Name="Scene" Tag="642" ctype="GameNodeObjectData">
        ...
        <Children>
          <AbstractNodeData Name="PanelStart" ActionTag="259838925" Tag="711" IconVisible="False" TouchEnable="True" BackColorAlpha="102" ComboBoxIndex="1" ColorAngle="90.0000" Scale9Width="1" Scale9Height="1" ctype="PanelObjectData">
            <Size X="640.0000" Y="1136.0000" />
            <Children>
              <AbstractNodeData Name="bg_base_16" ActionTag="-1344538284" Tag="714" Alpha="177" IconVisible="False" LeftMargin="-104.0480" RightMargin="-107.9520" ctype="SpriteObjectData">
              ...
              <AbstractNodeData Name="Particle_6" ActionTag="-875290500" Tag="715" IconVisible="True" LeftMargin="315.7928" RightMargin="324.2072" TopMargin="458.7773" BottomMargin="677.2227" ctype="ParticleObjectData">
                <Size />
                <AnchorPoint />
                <Position X="315.7928" Y="677.2227" />
                <Scale ScaleX="5.8191" ScaleY="5.8191" />
                <CColor A="255" R="255" G="255" B="255" />
                <PrePosition X="0.4934" Y="0.5961" />
                <PreSize />
          ...
          <AbstractNodeData Name="PanelNotice" ActionTag="-266291420" Tag="710" IconVisible="False" TouchEnable="True" BackColorAlpha="102" ComboBoxIndex="1" ColorAngle="90.0000" ctype="PanelObjectData">
            ...
            <Children>
              <AbstractNodeData Name="SpriteNotice" ActionTag="942886644" Tag="643" IconVisible="False" ctype="SpriteObjectData">
                ...
                <PrePosition />
                <PreSize />
                <FileData Type="Normal" Path="images/title/images/notice_image_1136.jpg" Plist="" />
                <BlendFunc Src="770" Dst="771" />
              </AbstractNodeData>
            </Children>
            <AnchorPoint />
